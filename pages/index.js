  ...
  return (
    <ErrorBoundary>
      ...
      <footer
        ...
        style={{ animation: 'indexFooterBg 8s ease-in-out infinite' }}
      >
        {/* Floating orbs */}
        ...
        {[...Array(14)].map((_, i) => (
          <div key={i} className="absolute w-2 h-2 rounded-full animate-ping"
            style={{
              background: ['#FFD700','#E53E3E','#38A169','#3182CE','#805AD5','#f7971e','#4facfe'][i % 7],
              top: `${5 + i * 6.5}%`, left: `${4 + i * 6.8}%`,
              animationDelay: `${i * 0.3}s`, animationDuration: '2.5s', opacity: 0.5
            }}
          />
        ))}
        ...
        {/* Floating stars */}
        {[...Array(8)].map((_, i) => (
          <div key={`fs-${i}`} className="absolute opacity-25 pointer-events-none select-none"
            style={{ top: `${8 + i * 11}%`, right: `${4 + i * 11}%`, animation: 'float 4s ease-in-out infinite', animationDelay: `${i * 0.5}s`, fontSize: ['14px','18px','12px','16px'][i % 4] }}
          >✨</div>
        ))}
        ...
        <div className="relative z-10 w-full px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2" style={{ animation: 'footerItemIn 0.6s ease both' }}>
              <h3
              ...
              <p className="text-lg font-semibold text-gray-800 mb-3">Where Elegance Meets Tradition</p>
              ...
              <div className="flex space-x-4">
                <a href="https://wa.me/919588253490" className="bg-green-500 p-3 rounded-full hover:bg-green-600 transition-all duration-300 hover:scale-110 hover:shadow-lg">
                  <MessageCircle className="w-5 h-5 text-white" />
                </a>
                <a href="tel:9588253490" className="bg-primary-maroon p-3 rounded-full hover:bg-deep-maroon transition-all duration-300 hover:scale-110 hover:shadow-lg">
                  <Phone className="w-5 h-5 text-white" />
                </a>
              </div>
            </div>

            <div style={{ animation: 'footerItemIn 0.6s ease both', animationDelay: '0.15s' }}>
              <h4 className="text-lg font-bold mb-5 text-gray-900 relative inline-block">
                Quick Links
                <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-primary-maroon to-royal-gold rounded-full" />
              </h4>
              <ul className="space-y-3">
                {[{href:'/products',label:'Collection'},{href:'/offers',label:'Special Offers'},{href:'/about',label:'About Us'},{href:'/contact',label:'Contact'}].map(({href,label},i) => (
                  <li key={href} style={{ animation: 'footerItemIn 0.5s ease both', animationDelay: `${0.2 + i * 0.08}s` }}>
                    <Link href={href}
                      className="text-gray-700 font-medium flex items-center gap-2 transition-all duration-300"
                      onMouseEnter={e => { e.currentTarget.style.transform = 'translateX(6px)'; e.currentTarget.style.color = '#8B0000'; }}
                      onMouseLeave={e => { e.currentTarget.style.transform = ''; e.currentTarget.style.color = ''; }}
                    >
                      <span className="w-1.5 h-1.5 rounded-full bg-primary-maroon" />
                      {label}
                    </Link>
                  </li>
                ))}
            ...
            <div style={{ animation: 'footerItemIn 0.6s ease both', animationDelay: '0.3s' }}>
              <h4 className="text-lg font-bold mb-5 text-gray-900 relative inline-block">
                Store Info
              ...
              <div className="space-y-3">
                {[
                  { icon: <MapPin className="w-4 h-4 flex-shrink-0 text-primary-maroon mt-1" />, text: 'Merta Road, Sadar Bazar, Near Namdev Vashtra Bhandar', color: '#8B0000' },
                  ...
                  <p key={i}
                    ...
                    style={{ animation: 'footerItemIn 0.5s ease both', animationDelay: `${0.35 + i * 0.1}s` }}
          ...
          <div className="border-t border-gray-300 mt-10 pt-6">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <p className="text-gray-600 text-center md:text-right mt-3 md:mt-0">
        ...
        <style>{`
          @keyframes indexFooterBg {
            0%   { background: linear-gradient(135deg,#fef9f0,#fff8e1,#fffef7); }
            25%  { background: linear-gradient(135deg,#f0fff4,#e6ffed,#f5fff8); }
            50%  { background: linear-gradient(135deg,#f0f4ff,#e8f0ff,#f5f8ff); }
            75%  { background: linear-gradient(135deg,#fff0f5,#ffe4f0,#fff5fb); }
